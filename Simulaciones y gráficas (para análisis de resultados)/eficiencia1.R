...
#Menu
plot(seq(0.4,5.9,by=0.1), intMEN, type='o', lwd=2, xlab='lambda',
...
lines(seq(0.4,5.9,by=0.1), intMEN, type='o', lwd=2, col='darkblue')
lines(seq(0.4,5.9,by=0.1), intBAR, type='o', lwd=2, col='red')
legend('topright', legend=c('Micro', 'Menu', 'Barra'), 
...
while (aforomax<250){
  ...
  intSEN = c(intSEN, mean(TSSEN)/mean(TLSEN))
